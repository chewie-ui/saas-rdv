...
4. `$()` - 20 edges
5. `sendEmail()` - 20 edges
6. `getBookableTeam()` - 16 edges
7. `render()` - 15 edges
8. `loadAccessibleCompanyOr403()` - 13 edges
9. `getPlan()` - 13 edges
...
- `requestJoinCompany()` --calls--> `getPlan()`  [INFERRED]
  controllers/account.controller.js → utils/planLimits.js
- `respondJoinRequest()` --calls--> `hasPermission()`  [INFERRED]
  controllers/account.controller.js → utils/permissions.js
...
Cohesion: 0.03
Nodes (13): bcrypt, Company, env, path, PLAN_LIMITS, pug, QRCode, { sanitizeRichText } (+5 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (21): AccessLink, { activeSupervisions }, Booking, Client, Company, crypto, DaysOff, Employee (+13 more)
...
Cohesion: 0.05
Nodes (37): dependencies, bcrypt, cheerio, compression, connect-mongo, cookie-parser, cross-env, dotenv (+29 more)
...
Cohesion: 0.08
Nodes (27): applyPromoBtn, applyPromoToUI(), billMonthly, billYearly, calcDiscounted(), cancelSubscriptionPro, confirmPurchase(), getBusinessPlan (+19 more)
...
Cohesion: 0.16
Nodes (12): { atLeast }, Booking, Company, cron, getAppointmentDateTime(), path, pug, sendDueReminders() (+4 more)
...
Cohesion: 0.19
Nodes (11): ADMIN_FEATURES, FeatureFlag, FEATURES, getAdminFeaturesFlags(), getFlagsMap(), isAdminFeatureEnabled(), isFeatureEnabled(), requireAdminFeature() (+3 more)
...
Cohesion: 0.50
Nodes (4): enforcePlanLimits(), paymentVerification(), setPlan(), setPlanForCompany()
